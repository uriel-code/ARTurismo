...
<body class="body">
    ...
    <br><br>
      ...
      <section class="d-flex justify-content-center align-items-center">
        <div class="Continer">
          <h1 class="Contactos">Contactos</h1><br><br>
          
          <img class="contactos-targeta" src="{{url('/img/contactoU.png')}}" alt=""><br><br>
          <img class="contactos-targeta" src="{{url('/img/contactoL.png')}}" alt=""><br><br>
        </div>
      </section>    
