...
<body class="body">
    ...
    <h1 class="titulo-monumentos">Galeria de Monumentos</h1><br><br>

    <div class="container">
    <!-- Targetas Monumentos-->
    <!-- El tamaño de las imajenes devern de ser de 286x180-->
    <div class="row">
        <div class="col-sm-3">
            <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="{{url('/img/monumentomi.jpg')}}" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Las Misiones Culturales</h5>
                <p class="card-text">Conoce aserca de su representación</p>
                <a href="/MonumentoMisiones" class="btn btn-primary">Ver más</a>
            </div>
            </div>
        </div>
